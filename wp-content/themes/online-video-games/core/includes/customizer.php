...
if ( class_exists("Kirki")){
	...
	new \Kirki\Field\Select(
	[
		'settings'    => 'online_video_games_page_layout',
		'label'       => esc_html__( 'Page Layout Setting', 'online-video-games' ),
		'section'     => 'online_video_games_additional_settings',
		'default' => 'Right Sidebar',
		'placeholder' => esc_html__( 'Choose an option', 'online-video-games' ),
		'choices'     => [
			'Left Sidebar' => __('Left Sidebar','online-video-games'),
            'Right Sidebar' => __('Right Sidebar','online-video-games'),
            'One Column' => __('One Column','online-video-games')
		],
	] );
	...
	new \Kirki\Field\Select(
	[
		'settings'    => 'online_video_games_shop_page_layout',
		'label'       => esc_html__( 'Shop Page Layout Setting', 'online-video-games' ),
		'section'     => 'online_video_games_woocommerce_settings',
		'default' => 'Right Sidebar',
		'placeholder' => esc_html__( 'Choose an option', 'online-video-games' ),
		'choices'     => [
	...
	new \Kirki\Field\Select(
	[
		'settings'    => 'online_video_games_product_page_layout',
		'label'       => esc_html__( 'Product Page Layout Setting', 'online-video-games' ),
		'section'     => 'online_video_games_woocommerce_settings',
		'default' => 'Right Sidebar',
		'placeholder' => esc_html__( 'Choose an option', 'online-video-games' ),
		'choices'     => [
		...
		new \Kirki\Field\Radio_Buttonset(
	[
		'settings'    => 'online_video_games_woocommerce_pagination_position',
		'label'       => esc_html__( 'Woocommerce Pagination Alignment', 'online-video-games' ),
		'section'     => 'online_video_games_woocommerce_settings',
		'default'     => 'Center',
		'priority'    => 10,
		'choices'     => [
	...
	Kirki::add_field( 'theme_config_id', [
		...
		new \Kirki\Field\Select(
	[
		'settings'    => 'online_video_games_archive_sidebar_layout',
		'label'       => esc_html__( 'Archive Post Sidebar Layout Setting', 'online-video-games' ),
		'section'     => 'online_video_games_section_post',
		'default' => 'Right Sidebar',
		'placeholder' => esc_html__( 'Choose an option', 'online-video-games' ),
		'choices'     => [
	...
	new \Kirki\Field\Select(
	[
		'settings'    => 'online_video_games_single_post_sidebar_layout',
		'label'       => esc_html__( 'Single Post Sidebar Layout Setting', 'online-video-games' ),
		'section'     => 'online_video_games_section_post',
		'default' => 'Right Sidebar',
		'placeholder' => esc_html__( 'Choose an option', 'online-video-games' ),
		'choices'     => [
	...
	new \Kirki\Field\Select(
	[
		'settings'    => 'online_video_games_search_sidebar_layout',
		'label'       => esc_html__( 'Search Page Sidebar Layout Setting', 'online-video-games' ),
		'section'     => 'online_video_games_section_post',
		'default' => 'Right Sidebar',
		'placeholder' => esc_html__( 'Choose an option', 'online-video-games' ),
		'choices'     => [
	...
	[
		...
		new \Kirki\Field\Select(
	[
		'settings'    => 'online_video_games_slider_opacity_color',
		'label'       => esc_html__( 'Slider Opacity Option', 'online-video-games' ),
		'section'     => 'online_video_games_blog_slide_section',
		'default'     => '0.6',
		'placeholder' => esc_html__( 'Choose an option', 'online-video-games' ),
		'choices'     => [
			'0' => esc_html__( '0', 'online-video-games' ),
			'0.1' => esc_html__( '0.1', 'online-video-games' ),
			'0.2' => esc_html__( '0.2', 'online-video-games' ),
			'0.3' => esc_html__( '0.3', 'online-video-games' ),
			'0.4' => esc_html__( '0.4', 'online-video-games' ),
			'0.5' => esc_html__( '0.5', 'online-video-games' ),
			'0.6' => esc_html__( '0.6', 'online-video-games' ),
			'0.7' => esc_html__( '0.7', 'online-video-games' ),
			'0.8' => esc_html__( '0.8', 'online-video-games' ),
			'0.9' => esc_html__( '0.9', 'online-video-games' ),
			'1.0' => esc_html__( '1.0', 'online-video-games' ),
	 ...
	 Kirki::add_field( 'theme_config_id', [
		'type'        => 'switch',
		'settings'    => 'online_video_games_overlay_option',
		'label'       => esc_html__( 'Enable / Disable Slider Overlay', 'online-video-games' ),
		'section'     => 'online_video_games_blog_slide_section',
		'default'     => false,
		'priority'    => 10,
		'choices'     => [
	 ...
	 Kirki::add_field( 'theme_config_id', [
		'type'        => 'color',
		'settings'    => 'online_video_games_slider_image_overlay_color',
		'label'       => __( 'choose your Appropriate Overlay Color', 'online-video-games' ),
		'section'     => 'online_video_games_blog_slide_section',
		'default'     => '',
	] );
